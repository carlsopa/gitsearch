  ...
  return (
    <div className="App">
      <header>
        ...
        <input type="text" class='git_input' id="headerSearch" placeholder="git profile...." onChange={(e)=>setSearchTerm(e.target.value)}/>
        <button class='git_submit' id='headersubmit' type="button" href="#" onClick={(e)=>FetchUser()}>Submit</button></div>:null}
      </header>
